	...
	<body>	
		...
		<div class="container-fluid">
			<div class="panel panel-primary">
				<div class="panel-heading" align="center">Upload branch plans</div>
				<div class="panel-body">	
					<form  method="post" enctype="multipart/form-data">
									<div class="row">
											...
											<div class="form-group  col-md-3">
												<label for="from" class="formText">Plan description</label>
			...
			<p></br></p>
			<div class="panel panel-primary">
				<div class="panel-heading"  style="text-align:center;">Branch Task Summary</div>
					<div class="panel-body">
