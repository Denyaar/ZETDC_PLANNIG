    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse" >        
             ...
             <ul class="nav" id="side-menu">
				...
				<li>
                     <a href="#"><i class="fa fa-calendar"></i> <span class="nav-label">My Tasks</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
						 <a href="index.php?page=today.php"><i class="fa fa-plus-circle"></i> <span class="nav-label">Today</span><span class="fa arrow"></span></a>
						</li>
					</ul>	
                </li>
				
                 <li>
					  <a href="#"><i class=" fa fa-qq"></i> <span class="nav-label">Requisitions</span><span class="fa arrow"></span></a>
                     <ul class="nav nav-second-level">
                        <li>
						 <a href="index.php?page=requisition.php"><i class="fa fa-calendar"></i> <span class="nav-label">Manage</span><span class="fa arrow"></span></a>
                    	</li>
					</ul>
				</li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
						 <a href="index.php?page=leave_form.php"><i class="fa fa-plus-circle"></i> <span class="nav-label">Leave form</span><span class="fa arrow"></span></a>
						</li>
					</ul>
				</li>
				<li>
