    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse" >        
             ...
             <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><?php  echo "Hi Supervisor ".ucfirst($name);?></strong>
                             </span>  </span> </a>
                    </div>
				...
				<li>
                     <a href="#"><i class="fa fa-calendar"></i> <span class="nav-label">Depot OKR's &amp; plans</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
						 <a href="index.php?page=plans.php"><i class="fa fa-download"></i><span class="nav-label">Branch Tasks</span><span class="fa arrow"></span></a>
   						 <a href="index.php?page=weekly.php"><i class="fa fa-plus-circle"></i> <span class="nav-label">Weekly Plans</span><span class="fa arrow"></span></a>
						</li>
					</ul>
                </li>
                 <li>
				...
				<li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
						 <a href="index.php?page=leave.php"><i class="fa fa-cog"></i> <span class="nav-label">Process Requests</span><span class="fa arrow"></span></a>
						</li>
					</ul>
				</li>
